...
const MobileTopUp = ({PaymentsScreen}) => {
        ...
        <View style={styles.wrapper}>
            ...
            <View style={styles.container1}>
                ...
                <View style={styles.text_container}>
                    <Text style={styles.top_text}>New mobile top up</Text>
                    <Text style={styles.footer_text}>Top up any prepaid mobile newtowrk operator</Text>
                </View>
            </View>
