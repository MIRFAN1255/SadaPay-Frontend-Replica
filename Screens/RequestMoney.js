...
const RequestMoney = ({ SendRequest }) => {
        ...
        <View style={styles.wrapper}>
            ...
            <View style={styles.container1}>
                ...
                <View style={styles.text_container}>
                    <Text style={styles.top_text}>New money request</Text>
                    <Text style={styles.footer_text}>Request money instantaly from SadaPay buddies</Text>
                </View>
            </View>
            <View style={styles.search_bar}>
                <View style={{
                    width: 50, height: 50, alignItems: 'center', justifyContent: 'center',
                    backgroundColor: 'transparent', borderRadius: 20, marginRight: 5
                }}>
                    <FAIcon name="search"
                        size={25} color="gray" />
                </View>
